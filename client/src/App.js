    ...
    drizzleReadinessState.loading ?
      ...
      <Router>
       ...
       <br />
         ...
         <Switch>
           <Route exact path="/">
            <ListTrees drizzle={drizzle} drizzleState={drizzleReadinessState.drizzleState} />
           </Route>
           <Route exact path="/myassets">
            <ListAssets drizzle={drizzle} drizzleState={drizzleReadinessState.drizzleState} />
           </Route>
           <Route exact path="/asset/:id">
            <AssetDetails drizzle={drizzle} drizzleState={drizzleReadinessState.drizzleState} />
           </Route>
